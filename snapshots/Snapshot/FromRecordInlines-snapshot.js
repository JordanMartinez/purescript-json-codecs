...
const encoder = /* #__PURE__ */ (() => {
  const $0 = Codec$dJson$dUnidirectional$dValue.fromRecordObjCons(Codec$dJson$dUnidirectional$dValue.fromRecordObjCons(Codec$dJson$dUnidirectional$dValue.fromRecordObjCons(Codec$dJson$dUnidirectional$dValue.fromRecordObjCons(Codec$dJson$dUnidirectional$dValue.fromRecordObjCons(Codec$dJson$dUnidirectional$dValue.fromRecordObjCons(Codec$dJson$dUnidirectional$dValue.fromRecordObjCons(Codec$dJson$dUnidirectional$dValue.fromRecordObjNil)({
...
const test = j => Data$dArgonaut$dCore.fromObject((() => {
  const $0 = Data$dArgonaut$dCore.fromString(j.zAppearsFirst);
