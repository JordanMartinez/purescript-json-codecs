  ...
  const $1 = {
    ...
    nested: (() => {
      ...
      return (lookupFn, recLabel) => {
        ...
        const v = lookupFn(recLabel);
        if (v.tag === "Nothing") { return Data$dEither.$Either("Left", $3(Codec$dJson$dUnidirectional$dValue.$DecodeError("DecodeError", "Missing field"))); }
        if (v.tag === "Just") {
          ...
          if ($4.tag === "Right") {
            ...
            if ($5.tag === "Right") {
              if ($5.tag === "Right") {
                ...
                if ($6.tag === "Right") { return Data$dEither.$Either("Right", {...$5._1, foo: $6._1}); }
                if ($6.tag === "Left") { return Data$dEither.$Either("Left", $3($6._1)); }
                $runtime.fail();
              }
              if ($5.tag === "Left") { return Data$dEither.$Either("Left", $3($5._1)); }
            }
            $runtime.fail();
          }
    ...
    if ($2.tag === "Right") {
      ...
      if ($3.tag === "Right") {
        if ($3.tag === "Right") {
          ...
          if ($4.tag === "Right") { return Data$dEither.$Either("Right", {...$3._1, nested: $4._1}); }
